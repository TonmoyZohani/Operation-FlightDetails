...
const VisaSearchBox = () => {
  ...
  const handleSearchVisa = () => {
    navigate("/dashboard/search/visaAfterSearch");
  };
      ...
      <Box>
          ...
          <Grid container item lg={11.2}>
            ...
            >
              ...
              >
                <Box sx={{ mt: "8px" }}>
                  <p>Enter Country</p>
                  <span className="addressTitle">Bangladesh</span>
                </Box>
              </Box>
              {openCountry && (
                <Box
            ...
            >
              ...
              >
                <Box sx={{ mt: "8px" }}>
                  <p>Visa Type</p>
                  <span className="addressTitle">Tourist Visa</span>
                </Box>
              </Box>
            </Grid>
          </Grid>
        ...
        >
          ...
          >
            ...
            inform you that the{" "}
            <b style={{ fontWeight: "600" }}> Visa Module </b> is currently
